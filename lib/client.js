window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region stylesheet
		const CSS = `
.did-root{font-size:12px;line-height:19px;margin:4px 0 2px;border:1px solid var(--dsw-alias-border-l2,rgba(128,128,128,.25));border-radius:6px;overflow:hidden;background:var(--dsw-alias-bg-layer-1,transparent)}
