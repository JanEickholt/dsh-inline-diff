...
/* The call errored: its diff was attempted, never applied. */
.did-root.did-failed {
	opacity: 0.55;
}
...
`;
		...
		function InlineDiffRow(props) {
			...
			if (hunks === null) {
				return react.createElement("div", { className: "did-root" + (block && block.isError ? " did-failed" : ""), ref: rootRef, style: cardStyle || undefined },
			...
			const rootClass = "did-root" + (block && block.isError ? " did-failed" : "");
