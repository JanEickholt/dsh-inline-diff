...
`;
		...
		// scope; diff cards and the Plugins-page card both subscribe here. The literal
		...
		// Reads through the shared wordsMode subscription; writes go through the
		// injected setHighlight, which echoes optimistically and lets the scope
		// subscription confirm. Hidden entirely while the Host does not serve the
		...
		function DiffHighlightCard(props) {
			...
			const choose = typeof setHighlight === "function" && settings.writable
				? setHighlight
				: () => {};
			return react.createElement("li", { className: "did-card" + (open ? " did-cardopen" : "") },
				react.createElement("button", {
					...
					react.createElement("span", { className: "did-cardtext" },
						react.createElement("span", { className: "did-cardname" }, "Inline diff"),
						react.createElement("span", { className: "did-carddesc" }, "Diff highlighting for edit and write tool calls")),
					chevron(open)),
				open ? react.createElement("div", { className: "did-cardbody" },
					settings.writable ? null : react.createElement("p", { className: "did-readonly", role: "status" },
						"Preferences are read-only in this session."),
					react.createElement("div", { className: "did-setting" },
						...
						react.createElement("div", { className: "did-seg", role: "group", "aria-label": "Diff highlighting" },
							segmentButton(HIGHLIGHT_WORDS, "Words", words, choose, !settings.writable),
							segmentButton(HIGHLIGHT_LINES, "Lines only", !words, choose, !settings.writable)
						)
					)
				) : null
			);
