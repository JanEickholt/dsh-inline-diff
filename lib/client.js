			...
			return react.createElement("li", { className: "did-card" + (open ? " did-cardopen" : "") },
				react.createElement("button", {
					...
					react.createElement("span", { className: "did-cardtext" },
						...
						react.createElement("span", { className: "did-carddesc" }, "Diff highlighting and indentation for edit and write tool calls")),
					chevron(open)),
				open ? react.createElement("div", { className: "did-cardbody" },
					...
					react.createElement("div", { className: "did-setting" },
						...
						react.createElement("div", { className: "did-seg", role: "group", "aria-label": "Diff highlighting" },
							segmentButton(HIGHLIGHT_WORDS, "Words", words, choose, !writable),
							segmentButton(HIGHLIGHT_LINES, "Lines only", !words, choose, !writable)
						)
					),
					react.createElement("div", { className: "did-setting" },
						react.createElement("span", { className: "did-setting-title" }, "Common indentation"),
						react.createElement("div", { className: "did-seg", role: "group", "aria-label": "Common indentation" },
							segmentButton(INDENT_STRIP, "Strip", !keepIndent, chooseIndent, !writable),
							segmentButton(INDENT_KEEP, "Keep", keepIndent, chooseIndent, !writable)
						)
					)
				) : null
			);
