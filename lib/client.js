...
`;
		...
		const MESSAGES = {
			en: {
				...
				"wallpaper.on": "On",
				"wallpaper.off": "Off",
				"fold.title": "Fold long hunks",
				"fold.on": "On",
				"fold.off": "Off",
				"fold.bar": "Show {count} hidden lines",
				"fold.bar.one": "Show {count} hidden line",
				"fold.hide": "Hide {count} lines",
				"fold.hide.one": "Hide {count} line",
				"fold.threshold": "Visible rows per end",
			...
			zh: {
				...
				"fold.on": "开",
				"fold.off": "关",
				"fold.bar": "显示 {count} 行隐藏内容",
				"fold.bar.one": "显示 {count} 行隐藏内容",
				"fold.hide": "收起 {count} 行",
				"fold.hide.one": "收起 {count} 行",
				"fold.threshold": "首尾各显示行数",
